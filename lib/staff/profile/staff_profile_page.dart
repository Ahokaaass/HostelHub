  ...
  Future<void> _pickAndUploadPhoto() async {
    ...
    try {
      ...
      final ref  = FirebaseStorage.instance
          .ref()
          .child('staff_profile_pics/${widget.userId}.jpg');
      ...
      if (mounted) _showSnack('Failed to upload photo. Try again.', Colors.red.shade600);
    } finally {
                              ...
                              Positioned(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: Colors.white,
                                    shape: BoxShape.circle,
                                    border: Border.all(color: _kBlueTint, width: 2),
                                    boxShadow: [BoxShadow(
                    ...
                    children: [
                      ...
                      Wrap(spacing: 10, runSpacing: 10, children: [
                        _Chip(Icons.badge_rounded,
                            'ID: ${d['staffId'] ?? '—'}'),
                        _Chip(Icons.manage_accounts_rounded,
                            d['userId'] ?? '—'),
                        if (hostel != null && hostel.toString().isNotEmpty)
                      ...
                      _Card(rows: [
                        ...
                        _R(roleIcon, 'Role', roleLabel),
                        _R(Icons.badge_rounded, 'Staff ID',
                            d['staffId'] ?? '—'),
                        _R(Icons.key_rounded, 'User ID',
                            d['userId'] ?? '—'),
                      ]),
                      ...
                      _Card(rows: [
                        ...
                        _R(Icons.phone_rounded, 'Phone',
                            d['phone'] ?? '—'),
                        if (hostel != null &&
                            hostel.toString().isNotEmpty)
                          _R(Icons.apartment_rounded, 'Hostel',
                              hostel.toString()),
                      ]),
          ...
          return Column(children: [
            Padding(
              ...
              child: Row(children: [
                ...
                Expanded(child: Text(r.label, style: const TextStyle(
                    fontSize: 13, color: _kGrey,
                    fontWeight: FontWeight.w500))),
                Flexible(child: Text(r.value, textAlign: TextAlign.end,
