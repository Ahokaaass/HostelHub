...
import 'emergency_read_info_page.dart'; // ← new
                      ...
                      children: [
                        Text('Emergency Alerts',
                            style: TextStyle(
                                ...
                                letterSpacing: -0.3)),
                        SizedBox(height: 2),
                        Text('Monitor and handle active alerts',
                            style: TextStyle(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return _EmergencyCard(
                      ...
                      onTap: () => Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (_) =>
                              EmergencyDetailPage(emergency: emergency),
                        ),
                      ),
                      onViewReads: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) =>
                              EmergencyReadInfoPage(emergency: emergency),
                        ),
                      ),
                    );
                  },
